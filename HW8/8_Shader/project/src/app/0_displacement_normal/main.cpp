...
int main()
{
  ...
  //  gl::Texture2D normalmap = loadTexture("../data/textures/NormalMap2.png");
  //  gl::Texture2D displacementmap = loadTexture("../data/textures/DisplacementMap2.png");
