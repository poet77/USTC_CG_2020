...
private:
    ...
    cv::Mat                     image_;
	cv::Mat                     image_back_;              //Restore the original image 
    cv::Mat                     image_backup_;            //Store the image when pasting
    std::vector<cv::Mat>		image_backup_vec_;        //Store the image when pasting
