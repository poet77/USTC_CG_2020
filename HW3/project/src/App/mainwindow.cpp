...
// 	action_new_->setStatusTip(tr("Create a new file"));
    ...
    // File IO
    action_open_ = new QAction(QIcon("../Resources/images/open.jpg"), tr("&Open..."), this);
    action_open_->setShortcuts(QKeySequence::Open);
    action_open_->setStatusTip(tr("Open an existing file"));
    connect(action_open_, SIGNAL(triggered()), this, SLOT(Open()));

    action_save_ = new QAction(QIcon("../Resources/images/save.jpg"), tr("&Save"), this);
    action_save_->setShortcuts(QKeySequence::Save);
    action_save_->setStatusTip(tr("Save the document to disk"));
    connect(action_save_, SIGNAL(triggered()), this, SLOT(Save()));

    action_saveas_ = new QAction(QIcon("../Resources/images/save.jpg"),tr("Save &As..."), this);
    ...
    action_free_ = new QAction(QIcon("../Resources/images/Freehand.png"),tr("Free"), this);
